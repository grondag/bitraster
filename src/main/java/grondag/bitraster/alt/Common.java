...
import static grondag.bitraster.alt.Config.PRECISE_COVERAGE;

public class Common {
	static final int SIMD_LANES = 4;
	static final int TILE_HEIGHT_SHIFT = 2;

	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	//Common defines and constants
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

	static final int SIMD_ALL_LANES_MASK = ((1 << SIMD_LANES) - 1);
	...
	static final int TILE_WIDTH_SHIFT = 5;
	static final int TILE_WIDTH = (1 << TILE_WIDTH_SHIFT);
	static final int TILE_HEIGHT = (1 << TILE_HEIGHT_SHIFT);

	//Sub-tiles (used for updating the masked HiZ buffer) are 8x4 tiles, so there are 4x2 sub-tiles in a tile
	static final int SUB_TILE_WIDTH = 8;
	static final int SUB_TILE_HEIGHT = 4;
	...
	static final int FP_BITS = PRECISE_COVERAGE ? 8 : (19 - TILE_HEIGHT_SHIFT);
	static final int FP_HALF_PIXEL = (1 << (FP_BITS - 1));
	static final float FP_INV = (1.0f / (1 << FP_BITS));

	//Tile dimensions in fixed point coordinates
	static final int FP_TILE_HEIGHT_SHIFT = (FP_BITS + TILE_HEIGHT_SHIFT);
	static final int FP_TILE_HEIGHT = (1 << FP_TILE_HEIGHT_SHIFT);
	...
	static final int MAX_CLIPPED = (8 * SIMD_LANES);
	static final int MAX_CLIPPED_WRAP = (MAX_CLIPPED - 1);
	...
	static final float GUARD_BAND_PIXEL_SIZE = 1.0f;
	...
	static final int BIG_TRIANGLE = 3;
